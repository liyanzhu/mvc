...
function content_5f4baedd70b388_46572984 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
?>
            <ul class="my-service-list">
                <li><img src="<?php echo $_smarty_tpl->tpl_vars['v']->value['imgurl'];?>
" alt=""></li>
